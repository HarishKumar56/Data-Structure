...
import org.nagarro.logic.MyPriorityQueue;
...
public class PriorityQueueHandler implements UserHandler {
		...
		try {
			while (true) {
				...
				case 4:
					...
					if (myQueue.contains(Integer.parseInt(br.readLine()))) {
				...
				case 9:
					return;
				case 10:
					System.out.println("Balance Factor  :"+myQueue.getBalance());
					break;
